...
% ============================================================
%  QIMMA -- TEMPLATE "EXAMEN BLANC"
%  Charte : logo + dégradé teal/emeraude + accent ambre,
%  fiche d'identité de l'élève, encart "conditions réelles".
% ============================================================
...
\newcommand{\niveau}{Niveau}               % TODO
\newcommand{\dateExamen}{JJ/MM/AAAA}       % TODO
...
\fancyfoot[L]{\raisebox{-0.15cm}{\includegraphics[height=0.35cm]{\logofile}}~\small\sffamily\color{inkgray}Qimma -- Examen blanc}
...
\begin{tcolorbox}[
  ...
  overlay={
    ...
    \node[anchor=north east, fill=qamber, text=qambertext, rounded corners=2pt,
          inner sep=4pt, font=\sffamily\bfseries\small] at ([xshift=-6mm,yshift=-6mm]frame.north east) {EXAMEN BLANC};
  }
]
\hspace{1.6cm}\centering
{\sffamily\color{white!85}\small\bfseries\MakeUppercase{Examen blanc n°\numeroExamen}}\\[2mm]
{\sffamily\bfseries\color{white}\fontsize{21}{25}\selectfont \matiere}\\[2mm]
...
\sffamily\bfseries\color{qtealdark}Nom \& Prénom : & \sffamily\bfseries\color{qtealdark}Date : & \sffamily\bfseries\color{qtealdark}Durée : \\[1mm]
\makebox[6cm]{\hrulefill} & \sffamily\dateExamen & \sffamily\duree \\[4mm]
\multicolumn{3}{l}{\sffamily\bfseries\color{qtealdark}Barème total : \sffamily\baremeTotal\ points}
\end{tabular}
\end{tcolorbox}
...
\begin{tcolorbox}[
  ...
  title={\sffamily\bfseries\color{qtealdark}\ding{51}~~Conditions de l'examen blanc},
  colbacktitle=tealpale, coltitle=qtealdark, boxrule=0.6pt,
  after skip=8mm
]
Cet examen est à réaliser dans les conditions réelles~: sans documents, en temps limité (\duree).\\
% TODO: consignes supplémentaires éventuelles
\end{tcolorbox}
...
% =====================================================
% CORRIGE / GRILLE D'AUTO-EVALUATION (optionnelle)
% =====================================================
% \newpage
